...
class _ApiService implements ApiService {
  ...
  Future<List<CharacterModel>> getCharactersById({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CharacterModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<CharacterModel> _value;
    try {
      _value = _result.data!
          .map(
  ...
  Future<SimpleCategoryModelResponse> getAllClans({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SimpleCategoryModelResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'clans',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SimpleCategoryModelResponse _value;
    try {
      _value = SimpleCategoryModelResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<CharacterResponseModel> getakAtsuki({int? limit, int? page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<CharacterResponseModel> getKara({int? limit, int? page}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'limit': limit, r'page': page};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
